...
// Restored Building & Engineering Modules
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const buildingCoreItems: NavItem[] = [
    ...
    { id: 'building_calculator', label: 'RCC Calculator', icon: Calculator, badge: 'IS456', badgeStyle: 'bg-emerald-900/60 text-emerald-300 border border-emerald-500/40 font-mono' }
  ];
